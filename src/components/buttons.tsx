  ...
  return (
    <button
      ...
      onClick={() => {
        ...
        //   );
        // }
        console.log("next ep playing")
      }}
      className="nextbtn hidden absolute bottom-[70px] sm:bottom-[83px] text-[15px] right-4 bg-black bg-opacity-80 text-white py-2 px-3 rounded-lg font-medium text-base cursor-pointer text-left font-inter items-center animate-show border border-solid border-white border-opacity-10"
    >
     <div className='flex flex-row items-center gap-2'>
     <img src="/Next Episode.svg" alt="" />
      Next Episode
     </div>
    </button>
  );
