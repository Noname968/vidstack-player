...
export function VideoLayout({ thumbnails }: VideoLayoutProps) {
  return (
    <>
      ...
      />
      <Controls.Root
        className={`${styles.controls} media-controls:opacity-100 absolute inset-0 z-20 flex h-full w-full flex-col bg-gradient-to-t from-black/30 via-transparent to-black/30 opacity-0 transition-opacity`}
      >
        ...
        <Controls.Group className="-mt-0.5 flex w-full items-center px-2 pb-2">
          ...
          <Buttons.PlayNextButton tooltipPlacement="top" />
