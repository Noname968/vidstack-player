...
import { a as useSignal, o as isBoolean, m as isArray, C as uppercaseFirstChar, i as isUndefined, l as listenEvent, J as toggleClass, K as useReactScope, q as camelToKebabCase, L as useContext } from './vidstack-v3pWuBpF.js';
import { c as createComputed, R as Root$2, T as Trigger, C as Content, G as GoogleCastButton, a as Title, b as ChapterTitle$1, u as useChapterOptions, d as Captions, e as Root$6, f as Group, g as useChapterTitle, h as createEffect, i as Root$7, j as Track$1, k as TrackFill$1 } from './vidstack-CbEFfR4V.js';
import { b as useResizeObserver, u as useLayoutName, c as useTransitionActive, d as useActive, e as useMouseEnter, f as useRectCSSVars } from './vidstack-D2VpSFGD.js';
...
import { u as useMediaState, A as isTrackCaptionKind, q as isRemotionSource, B as mediaContext } from './vidstack-DIXbEOjz.js';
import { b as RemotionSliderThumbnail, R as RemotionThumbnail } from './vidstack-YhK_ZmK3.js';
...
function DefaultPlayButton({ tooltip }) {
  const { icons: Icons } = useDefaultLayoutContext(), playText = useDefaultLayoutWord("Play"), pauseText = useDefaultLayoutWord("Pause"), $paused = useMediaState("paused"), $ended = useMediaState("ended"), label = $paused ? playText : pauseText;
...
const DefaultMuteButton = React.forwardRef(
  ({ tooltip }, forwardRef) => {
    const { icons: Icons } = useDefaultLayoutContext(), muteText = useDefaultLayoutWord("Mute"), unmuteText = useDefaultLayoutWord("Unmute"), $muted = useMediaState("muted"), $volume = useMediaState("volume"), label = $muted ? unmuteText : muteText;
    return /* @__PURE__ */ React.createElement(DefaultTooltip, { content: $muted ? unmuteText : muteText, placement: tooltip }, /* @__PURE__ */ React.createElement(MuteButton, { className: "vds-mute-button vds-button", "aria-label": label, ref: forwardRef }, $muted || $volume == 0 ? /* @__PURE__ */ React.createElement(Icons.MuteButton.Mute, { className: "vds-icon" }) : $volume < 0.5 ? /* @__PURE__ */ React.createElement(Icons.MuteButton.VolumeLow, { className: "vds-icon" }) : /* @__PURE__ */ React.createElement(Icons.MuteButton.VolumeHigh, { className: "vds-icon" })));
  }
);
DefaultMuteButton.displayName = "DefaultMuteButton";
function DefaultCaptionButton({ tooltip }) {
  const { icons: Icons } = useDefaultLayoutContext(), onText = useDefaultLayoutWord("Closed-Captions On"), offText = useDefaultLayoutWord("Closed-Captions Off"), $track = useMediaState("textTrack"), isOn = $track && isTrackCaptionKind($track), label = $track ? offText : onText;
...
function DefaultPIPButton({ tooltip }) {
  const { icons: Icons } = useDefaultLayoutContext(), enterText = useDefaultLayoutWord("Enter PiP"), exitText = useDefaultLayoutWord("Exit PiP"), $pip = useMediaState("pictureInPicture"), label = $pip ? exitText : enterText;
...
function DefaultFullscreenButton({ tooltip }) {
  const { icons: Icons } = useDefaultLayoutContext(), enterText = useDefaultLayoutWord("Enter Fullscreen"), exitText = useDefaultLayoutWord("Exit Fullscreen"), $fullscreen = useMediaState("fullscreen"), label = $fullscreen ? exitText : enterText;
...
function DefaultVideoKeyboardActionDisplay() {
  useReactScope(); const {
    ...
    icons: Icons,
    noKeyboardActionDisplay
  } = React.useContext(DefaultLayoutContext), [visible, setVisible] = React.useState(false), [Icon, setIcon] = React.useState(null), $lastKeyboardAction = useMediaState("lastKeyboardAction");
  ...
  createEffect(() => {
    const Icon2 = getIcon(Icons.KeyboardAction);
    setIcon(() => Icon2);
  }, [Icons]);
  React.useEffect(() => {
  ...
  if (noKeyboardActionDisplay)
    return null;
  return /* @__PURE__ */ React.createElement("div", { className, "data-action": actionDataAttr }, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-text-wrapper" }, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-text" }, $text)), Icon ? /* @__PURE__ */ React.createElement("div", { className: "vds-kb-bezel", role: "status", "aria-label": $statusLabel }, /* @__PURE__ */ React.createElement("div", { className: "vds-kb-icon" }, /* @__PURE__ */ React.createElement(Icon, null))) : null);
}
...
function DefaultVideoLargeLayout() {
  const { menuGroup } = React.useContext(DefaultLayoutContext), baseSlots = useDefaultVideoLayoutSlots(), slots = { ...baseSlots, ...baseSlots?.largeLayout };
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DefaultVideoGestures, null), /* @__PURE__ */ React.createElement(DefaultVideoKeyboardActionDisplay, null), slot(slots, "bufferingIndicator", /* @__PURE__ */ React.createElement(DefaultBufferingIndicator, null)), slot(slots, "captions", /* @__PURE__ */ React.createElement(Captions, { className: "vds-captions" })), /* @__PURE__ */ React.createElement(Root$6, { className: "vds-controls" }, /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), menuGroup === "top" && /* @__PURE__ */ React.createElement(DefaultVideoMenus, { slots })), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "timeSlider", /* @__PURE__ */ React.createElement(DefaultTimeSlider, null))), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "playButton", /* @__PURE__ */ React.createElement(DefaultPlayButton, { tooltip: "top start" })), slot(slots, "muteButton", /* @__PURE__ */ React.createElement(DefaultMuteButton, { tooltip: "top" })), slot(slots, "volumeSlider", /* @__PURE__ */ React.createElement(DefaultVolumeSlider, null)), /* @__PURE__ */ React.createElement(DefaultTimeInfo, { slots }), slot(slots, "chapterTitle", /* @__PURE__ */ React.createElement(DefaultChapterTitle, null)), slot(slots, "captionButton", /* @__PURE__ */ React.createElement(DefaultCaptionButton, { tooltip: "top" })), menuGroup === "bottom" && /* @__PURE__ */ React.createElement(DefaultVideoMenus, { slots }), slot(slots, "airPlayButton", /* @__PURE__ */ React.createElement(DefaultAirPlayButton, { tooltip: "top" })), slot(slots, "googleCastButton", /* @__PURE__ */ React.createElement(DefaultGoogleCastButton, { tooltip: "top" })), slot(slots, "pipButton", /* @__PURE__ */ React.createElement(DefaultPIPButton, { tooltip: "top" })), slot(slots, "fullscreenButton", /* @__PURE__ */ React.createElement(DefaultFullscreenButton, { tooltip: "top end" })))));
}
...
function DefaultVideoSmallLayout() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(DefaultVideoGestures, null), slot(slots, "bufferingIndicator", /* @__PURE__ */ React.createElement(DefaultBufferingIndicator, null)), slot(slots, "captions", /* @__PURE__ */ React.createElement(Captions, { className: "vds-captions" })), /* @__PURE__ */ React.createElement(Root$6, { className: "vds-controls" }, /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "airPlayButton", /* @__PURE__ */ React.createElement(DefaultAirPlayButton, { tooltip: "top start" })), slot(slots, "googleCastButton", /* @__PURE__ */ React.createElement(DefaultGoogleCastButton, { tooltip: "top start" })), /* @__PURE__ */ React.createElement(DefaultControlsSpacer, null), slot(slots, "captionButton", /* @__PURE__ */ React.createElement(DefaultCaptionButton, { tooltip: "bottom" })), /* @__PURE__ */ React.createElement(DefaultVideoMenus, { slots }), slot(slots, "muteButton", /* @__PURE__ */ React.createElement(DefaultMuteButton, { tooltip: "bottom end" }))), /* @__PURE__ */ React.createElement("div", { className: "vds-controls-group" }, slot(slots, "playButton", /* @__PURE__ */ React.createElement(DefaultPlayButton, { tooltip: "top" }))), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, /* @__PURE__ */ React.createElement(DefaultTimeInfo, { slots }), slot(slots, "chapterTitle", /* @__PURE__ */ React.createElement(DefaultChapterTitle, null)), slot(slots, "fullscreenButton", /* @__PURE__ */ React.createElement(DefaultFullscreenButton, { tooltip: "top end" }))), /* @__PURE__ */ React.createElement(Group, { className: "vds-controls-group" }, slot(slots, "timeSlider", /* @__PURE__ */ React.createElement(DefaultTimeSlider, null)))), slot(slots, "startDuration", /* @__PURE__ */ React.createElement(DefaultVideoStartDuration, null)));
}
...
export { DefaultTimeInvert as A, DefaultChaptersMenu as B, DefaultSettingsMenu as C, DefaultLayoutContext as D, useDefaultLayoutWord as a, DefaultAudioLayout as b, DefaultVideoLayout as c, DefaultVideoLargeLayout as d, DefaultVideoSmallLayout as e, DefaultVideoGestures as f, DefaultBufferingIndicator as g, DefaultTooltip as h, i18n as i, DefaultAirPlayButton as j, DefaultGoogleCastButton as k, DefaultPlayButton as l, DefaultMuteButton as m, DefaultCaptionButton as n, DefaultPIPButton as o, DefaultFullscreenButton as p, DefaultSeekButton as q, DefaultVolumeSlider as r, DefaultTimeSlider as s, DefaultTitle as t, useDefaultLayoutContext as u, DefaultChapterTitle as v, DefaultLiveButton as w, DefaultTimeGroup as x, DefaultControlsSpacer as y, DefaultTimeInfo as z };
