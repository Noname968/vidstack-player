...
// node_modules/@vidstack/react/dist/dev/chunks/vidstack-v3pWuBpF.js
...
var DOMEvent = class extends EVENT {
  constructor(type, ...init2) {
    ...
    this.detail = (_a3 = init2[0]) == null ? void 0 : _a3.detail;
    const trigger = (_b2 = init2[0]) == null ? void 0 : _b2.trigger;
    if (trigger)
...
var EMPTY_PROPS = {};
var Instance = class {
  constructor(Component22, scope, init2) {
    var _a3;
    this[_a] = null;
    this.$el = signal(null);
    this._el = null;
    ...
    let stateFactory = Component22.state, props = Component22.props;
    if (stateFactory) {
    ...
    if (props) {
      ...
      if (init2 == null ? void 0 : init2.props) {
        for (const prop2 of Object.keys(init2.props)) {
          (_a3 = this._props[prop2]) == null ? void 0 : _a3.set(init2.props[prop2]);
        }
      }
    }
  ...
  _attach(el) {
    ...
    this.$el.set(el);
    {
      el.$$COMPONENT_NAME = (_a3 = this._component) == null ? void 0 : _a3.constructor.name;
    }
    scoped(() => {
  ...
  _detach() {
    var _a3;
    (_a3 = this._attachScope) == null ? void 0 : _a3.dispose();
    this._attachScope = null;
    this._connectScope = null;
    if (this._el) {
  ...
  _disconnect() {
    var _a3;
    (_a3 = this._connectScope) == null ? void 0 : _a3.dispose();
    this._connectScope = null;
  }
  _destroy() {
    if (this._destroyed)
...
function createComponent(Component22, init2) {
  return root(() => {
    currentInstance.$$ = new Instance(Component22, getScope(), init2);
...
var _ScopeProvider = class _ScopeProvider2 extends React.Component {
  constructor(props, context) {
    ...
    if (Ctor._context)
      provideContext(Ctor._context, (_a3 = Ctor._provide) == null ? void 0 : _a3.call(Ctor), this._scope.current);
  }
  render() {
    var _a3;
    return WithScope(this._scope, (_a3 = this.props) == null ? void 0 : _a3.children);
  }
};
  ...
  const forwardComponent = React.forwardRef((props, forwardRef3) => {
    ...
    function onAttach() {
      ...
      if (!state2._forwardedRef) {
        setRef(forwardRef3, state2._component);
    ...
    for (const name of [...prevPropNames, ...newPropNames]) {
      if (options.props.has(name)) {
        state._component.$props[name].set(
          ...
          isUndefined(__props[name]) ? (_a3 = Component22.props) == null ? void 0 : _a3[name] : __props[name]
        );
      } else if (((_b2 = options.events) == null ? void 0 : _b2.has(name)) || ((_c2 = options.eventsRE) == null ? void 0 : _c2.test(name))) {
        ...
        if (!newPropNames.includes(name)) {
          (_f = state._el) == null ? void 0 : _f.removeEventListener(type, state._onDOMEvent);
          (_g = state._listening) == null ? void 0 : _g.delete(type);
        } else if (state._el && !((_h = state._listening) == null ? void 0 : _h.has(type))) {
          if (!state._listening)
...
function createInternalState() {
  const state = {
    ...
    _onDOMEvent(event) {
      ...
      (_b2 = (_a3 = state._domCallbacks)[event.type]) == null ? void 0 : _b2.call(_a3, ...args);
    }
  };
  return state;
}
...
function onDispatch(event) {
  ...
  (_b2 = (_a3 = this._callbacks)[callbackProp]) == null ? void 0 : _b2.call(_a3, ...args);
}
...
function createServerComponent(Component22, options) {
  function ServerComponent(props) {
    let scope = React.useContext(ReactScopeContext), component = createComponent(Component22, {
      props,
      scope: scope.current
    }), host = new MaverickServerElement(component), attrs = {}, { style = {}, children, forwardRef: forwardRef3, ...__props } = props;
  ...
  ServerComponent.displayName = Component22.name + "Bridge";
...
function createReactComponent(Component22, options) {
  if (IS_SERVER) {
    return createServerComponent(Component22, {
      props: new Set(Object.keys(Component22.props || {}))
    });
  } else {
    return createClientComponent(Component22, {
      props: new Set(Object.keys(Component22.props || {})),
...
// node_modules/@vidstack/react/dist/dev/chunks/vidstack-DIXbEOjz.js
...
var _GroupedLog = class _GroupedLog2 {
  ...
  groupEnd() {
    var _a3;
    (_a3 = this.parent) == null ? void 0 : _a3.logs.push(this);
...
var Logger = class {
  ...
  dispatch(level, ...data) {
    var _a3;
    return ((_a3 = this._target) == null ? void 0 : _a3.dispatchEvent(
...
var List = class extends EventsTarget {
  ...
  [(_a$12 = ListSymbol._readonly, Symbol.iterator)]() {
  ...
  [ListSymbol._remove](item, trigger) {
    ...
    if (index >= 0) {
      (_a3 = this[ListSymbol._onRemove]) == null ? void 0 : _a3.call(this, item, trigger);
  ...
  [ListSymbol._reset](trigger) {
    ...
    (_a3 = this[ListSymbol._onReset]) == null ? void 0 : _a3.call(this);
  }
  /* @internal */
...
var UA = IS_SERVER2 ? "" : (navigator == null ? void 0 : navigator.userAgent.toLowerCase()) || "";
var IS_IOS = !IS_SERVER2 && /iphone|ipad|ipod|ios|crios|fxios/i.test(UA);
var IS_IPHONE = !IS_SERVER2 && /(iphone|ipod)/gi.test((navigator == null ? void 0 : navigator.platform) || "");
var IS_CHROME = !IS_SERVER2 && !!window.chrome;
var IS_SAFARI = !IS_SERVER2 && (!!window.safari || IS_IOS);
function canOrientScreen() {
  return canRotateScreen() && isFunction(screen.orientation.unlock);
}
function canRotateScreen() {
  return !IS_SERVER2 && !isUndefined(window.screen.orientation) && !isUndefined(window.screen.orientation.lock);
}
...
function getMediaSource() {
  return IS_SERVER2 ? void 0 : (window == null ? void 0 : window.ManagedMediaSource) ?? (window == null ? void 0 : window.MediaSource) ?? (window == null ? void 0 : window.WebKitMediaSource);
}
function getSourceBuffer() {
  return IS_SERVER2 ? void 0 : (window == null ? void 0 : window.SourceBuffer) ?? (window == null ? void 0 : window.WebKitSourceBuffer);
}
...
var TextTrack = class extends EventsTarget {
  constructor(init2) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (!IS_SERVER2 && init2.content) {
      import("./dev-5KEHKMO3.js").then(({ parseText, VTTCue, VTTRegion }) => {
  ...
  addCue(cue, trigger) {
    ...
    if ((trigger == null ? void 0 : trigger.type) !== "cuechange") {
      (_a3 = this[TextTrackSymbol._native]) == null ? void 0 : _a3.track.addCue(cue);
    }
  ...
  removeCue(cue, trigger) {
    ...
    if (index >= 0) {
      ...
      (_a3 = this[TextTrackSymbol._native]) == null ? void 0 : _a3.track.removeCue(cue);
  ...
  setMode(mode, trigger) {
    ...
    (_a3 = this[TextTrackSymbol._onModeChange]) == null ? void 0 : _a3.call(this);
  }
  /* @internal */
  [(_a2 = TextTrackSymbol._readyState, _b = TextTrackSymbol._onModeChange, _c = TextTrackSymbol._native, TextTrackSymbol._updateActiveCues)](currentTime, trigger) {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-5KEHKMO3.js"), crossOrigin = (_a3 = this[TextTrackSymbol._crossOrigin]) == null ? void 0 : _a3.call(this);
  ...
  _readyState() {
    ...
    if (!this.src || this.type !== "vtt") {
      const nativeTrack = (_a3 = this[TextTrackSymbol._native]) == null ? void 0 : _a3.track;
      if (nativeTrack)
...
var MediaRemoteControl = class {
  ...
  setTarget(target) {
    var _a3;
    this._target = target;
    (_a3 = this._logger) == null ? void 0 : _a3.setTarget(target);
  }
  /**
  ...
  getPlayer(target) {
    ...
    if (this._player)
      return this._player;
    (_a3 = target ?? this._target) == null ? void 0 : _a3.dispatchEvent(
  ...
  _dispatchRequest(type, trigger, detail) {
    ...
    if (target && target instanceof Component2)
      target = target.el;
    const shouldUsePlayer = !target || target === document || target === window || target === document.body || ((_a3 = this._player) == null ? void 0 : _a3.el) && target instanceof Node && !this._player.el.contains(target);
    ...
    if (isKeyboardEvent(event)) {
      if (event.key === "Escape") {
        ...
        requestAnimationFrame(() => {
          var _a4;
          (_a4 = this._focusedItem) == null ? void 0 : _a4.focus();
          this._focusedItem = null;
        });
      }
    }
...
var NativeTextRenderer = class {
  ...
  removeTrack(track) {
    var _a3, _b2;
    (_b2 = (_a3 = track[TextTrackSymbol._native]) == null ? void 0 : _a3.remove) == null ? void 0 : _b2.call(_a3);
  ...
  _attachTrack(track) {
    ...
    if (!this._video)
      return;
    const el = track[_a3 = TextTrackSymbol._native] ?? (track[_a3] = this._createTrackElement(track));
  ...
  _onChange(event) {
    var _a3;
    for (const track of this._tracks) {
      const nativeTrack = (_a3 = track[TextTrackSymbol._native]) == null ? void 0 : _a3.track;
      if (!nativeTrack)
        continue;
      if (!this._display) {
...
var TextRenderers = class {
  ...
  _addNativeTrack(track) {
    ...
    if (!isTrackCaptionKind(track))
      return;
    (_a3 = this._nativeRenderer) == null ? void 0 : _a3.addTrack(track);
  }
  _removeNativeTrack(track) {
    var _a3;
    if (!isTrackCaptionKind(track))
      return;
    (_a3 = this._nativeRenderer) == null ? void 0 : _a3.removeTrack(track);
  }
  _onAddTrack(event) {
  ...
  _update() {
    ...
    if (this._video && (this._nativeDisplay || (currentTrack == null ? void 0 : currentTrack[TextTrackSymbol._nativeHLS]))) {
      (_a3 = this._customRenderer) == null ? void 0 : _a3.changeTrack(null);
  ...
  _detach() {
    var _a3, _b2;
    (_a3 = this._nativeRenderer) == null ? void 0 : _a3.detach();
    this._nativeRenderer = null;
...
var TextTrackList = class extends List {
  constructor() {
    ...
    this._selectTracks = functionDebounce(async () => {
      ...
      const showCaptions = await ((_a3 = this._storage) == null ? void 0 : _a3.getCaptions()), kinds = [
        ["captions", "subtitles"],
        "chapters",
        "descriptions",
        "metadata"
  ...
  _saveCaptionsTrack(track) {
    ...
    (_b2 = (_a3 = this._storage) == null ? void 0 : _a3.setCaptions) == null ? void 0 : _b2.call(_a3, track.mode === "showing");
  }
  _saveLang(lang) {
    var _a3, _b2;
    (_b2 = (_a3 = this._storage) == null ? void 0 : _a3.setLang) == null ? void 0 : _b2.call(_a3, this._preferredLang = lang);
  }
  setStorage(storage) {
  ...
  [ListSymbol._add](item, trigger) {
    ...
    Object.defineProperty(item, "selected", {
      ...
      set: (selected) => {
        ...
        if (this.readonly)
          return;
        (_a3 = this[ListSymbol._onUserSelect]) == null ? void 0 : _a3.call(this);
...
var VideoQualityList = class extends SelectList {
  ...
  autoSelect(trigger) {
    ...
    if (this.readonly || this._auto || !this[QualitySymbol._enableAuto])
      return;
    (_a3 = this[QualitySymbol._enableAuto]) == null ? void 0 : _a3.call(this);
...
function isVimeoProvider(provider) {
  return (provider == null ? void 0 : provider.$$PROVIDER_TYPE) === "VIMEO";
}
function isGoogleCastProvider(provider) {
  return (provider == null ? void 0 : provider.$$PROVIDER_TYPE) === "GOOGLE_CAST";
}
function isHTMLAudioElement(element) {
  return !IS_SERVER2 && element instanceof HTMLAudioElement;
}
function isHTMLVideoElement(element) {
  return !IS_SERVER2 && element instanceof HTMLVideoElement;
}
function isHTMLMediaElement(element) {
  return isHTMLAudioElement(element) || isHTMLVideoElement(element);
}
function isHTMLIFrameElement(element) {
  return !IS_SERVER2 && element instanceof HTMLIFrameElement;
}
...
var MediaKeyboardController = class extends MediaPlayerController {
  ...
  _onKeyUp(event) {
    ...
    if (!isString(value) && !isArray(value)) {
      ...
      (_b2 = value == null ? void 0 : value.callback) == null ? void 0 : _b2.call(value, event, this._media.remote);
      return;
    }
  ...
  _onKeyDown(event) {
    ...
    switch (method2) {
      ...
      case "slowDown":
        ...
        break;
      default:
        (_d = (_c2 = this._media.remote)[method2]) == null ? void 0 : _d.call(_c2, event);
    }
  ...
  _forwardTimeKeyboardEvent(event, forward) {
    var _a3;
    (_a3 = this._timeSlider) == null ? void 0 : _a3.dispatchEvent(
...
function isVideoSrc(src) {
  return isString(src.src) ? VIDEO_EXTENSIONS.test(src.src) || VIDEO_TYPES.has(src.type) || src.src.startsWith("blob:") && src.type === "video/object" || isHLSSrc(src) && (IS_SERVER2 || canPlayHLSNatively()) : src.type === "video/object";
}
...
function isMediaStream(src) {
  return !IS_SERVER2 && typeof window.MediaStream !== "undefined" && src instanceof window.MediaStream;
}
var AudioProviderLoader = class {
  ...
  canPlay(src) {
    if (!isAudioSrc(src))
      return false;
    return IS_SERVER2 || !isString(src.src) || src.type === "?" || canPlayAudioType(this.target, src.type);
  }
  mediaType() {
    return "audio";
  }
  async load(ctx) {
    ...
    return new (await import("./vidstack-Bwu2NoVZ-N4DKUP2V.js")).AudioProvider(this.target, ctx);
  }
};
var VideoProviderLoader = class {
  ...
  canPlay(src) {
    if (!isVideoSrc(src))
      return false;
    return IS_SERVER2 || !isString(src.src) || src.type === "?" || canPlayVideoType(this.target, src.type);
  }
  mediaType() {
    return "video";
  }
  async load(ctx) {
    ...
    return new (await import("./vidstack-yWcnxZ6O-RUUDKJXU.js")).VideoProvider(this.target, ctx);
  }
};
var _HLSProviderLoader = class _HLSProviderLoader2 extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-CiZbDcd4-AKBUAJOO.js")).HLSProvider(this.target, context);
  }
};
...
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-LxLCezlI-3CCUF6FD.js")).VimeoProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { resolveVimeoVideoId, getVimeoVideoInfo } = await import("./vidstack-BTBUzdbF-SGQTIEEH.js");
    if (!isString(src.src))
      return null;
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-BMiDnKnR-WNFJS34J.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { findYouTubePoster, resolveYouTubeVideoId } = await import("./vidstack-DscYSLiW-6K6APBXJ.js");
...
var MediaEventsLogger = class extends MediaPlayerController {
  ...
  _onMediaEvent(event) {
    var _a3;
    (_a3 = this._media.logger) == null ? void 0 : _a3.debugGroup(`📡 dispatching \`${event.type}\``).labelledLog("Media Store", { ...this.$state }).labelledLog("Event", event).dispatch();
  }
};
...
var MediaPlayerDelegate = class {
  ...
  async _ready(info, trigger) {
    ...
    return untrack(async () => {
      ...
      let provider = this._media.$provider(), { storage } = this._media, { muted, volume, clipStartTime, playbackRate } = this._media.$props;
      const remotePlaybackTime = (_b2 = (_a3 = remotePlaybackInfo()) == null ? void 0 : _a3.savedState) == null ? void 0 : _b2.currentTime, wasRemotePlaying = ((_d = (_c2 = remotePlaybackInfo()) == null ? void 0 : _c2.savedState) == null ? void 0 : _d.paused) === false, startTime = remotePlaybackTime ?? await (storage == null ? void 0 : storage.getTime()) ?? clipStartTime(), shouldAutoPlay = wasRemotePlaying || autoPlay();
      if (provider) {
        ...
        (_e = provider.setPlaybackRate) == null ? void 0 : _e.call(provider, await (storage == null ? void 0 : storage.getPlaybackRate()) ?? playbackRate());
        (_f = provider.setPlaysInline) == null ? void 0 : _f.call(provider, playsInline());
        if (startTime > 0)
  ...
  async _attemptAutoplay(trigger) {
    ...
    try {
      ...
      if (!seenAutoplayWarning) {
        ...
        (_a3 = this._media.logger) == null ? void 0 : _a3.errorGroup("[vidstack] auto-play request failed").labelledLog(
          "Message",
...
var Queue = class {
   ...
   */
  _enqueue(key2, item) {
    this._queue.set(key2, item);
  }
  /**
   * Process item in queue for the given `key`.
   */
  _serve(key2) {
    const value = this._peek(key2);
...
var RequestQueue = class {
  ...
  _serve(key2) {
    var _a3;
    (_a3 = this._queue.get(key2)) == null ? void 0 : _a3();
    this._queue.delete(key2);
  }
  /**
...
var MediaRequestManager = class extends MediaPlayerController {
  ...
  _handleRequest(event) {
    ...
    if (event.defaultPrevented)
      return;
    {
      (_a3 = this._media.logger) == null ? void 0 : _a3.infoGroup(`📬 received \`${event.type}\``).labelledLog("Request", event).dispatch();
    }
    if (!this[event.type])
      return;
  ...
  _onAirPlaySupportChange() {
    var _a3, _b2;
    const { canAirPlay } = this.$state, supported = !!((_b2 = (_a3 = this._$provider()) == null ? void 0 : _a3.airPlay) == null ? void 0 : _b2.supported);
    canAirPlay.set(supported);
  }
  _onGoogleCastSupportChange() {
  ...
  _onFullscreenSupportChange() {
    var _a3, _b2;
    const { canFullscreen: canFullscreen2 } = this.$state, supported = this._fullscreen.supported || !!((_b2 = (_a3 = this._$provider()) == null ? void 0 : _a3.fullscreen) == null ? void 0 : _b2.supported);
    canFullscreen2.set(supported);
  }
  _onPiPSupportChange() {
    var _a3, _b2;
    const { canPictureInPicture } = this.$state, supported = !!((_b2 = (_a3 = this._$provider()) == null ? void 0 : _a3.pictureInPicture) == null ? void 0 : _b2.supported);
  ...
  async _requestAirPlay(trigger) {
    var _a3;
    try {
      const adapter = (_a3 = this._$provider()) == null ? void 0 : _a3.airPlay;
  ...
  async _requestGoogleCast(trigger) {
    try {
      ...
      if (!this._googleCastLoader) {
        const $module = await import("./vidstack-2k_oWHKR-NLAX3BPU.js").then(function(n) {
          return n.d;
        });
  ...
  ["media-audio-track-change-request"](event) {
    ...
    if (this._media.audioTracks.readonly) {
      {
        (_a3 = this._media.logger) == null ? void 0 : _a3.warnGroup(`[vidstack] attempted to change audio track but it is currently read-only`).labelledLog("Request Event", event).dispatch();
      }
      return;
    }
    ...
    if (track) {
      ...
      this._request._queue._enqueue(key2, event);
      track.selected = true;
    } else {
      (_b2 = this._media.logger) == null ? void 0 : _b2.warnGroup("[vidstack] failed audio track change request (invalid index)").labelledLog("Audio Tracks", this._media.audioTracks.toArray()).labelledLog("Index", index).labelledLog("Request Event", event).dispatch();
    }
  }
  ...
  async ["media-orientation-lock-request"](event) {
    ...
    try {
      ...
      this._request._queue._delete(key2);
      {
  ...
  ["media-quality-change-request"](event) {
    ...
    if (this._media.qualities.readonly) {
      {
        (_a3 = this._media.logger) == null ? void 0 : _a3.warnGroup(`[vidstack] attempted to change video quality but it is currently read-only`).labelledLog("Request Event", event).dispatch();
      }
      return;
    }
    ...
    if (index < 0) {
      ...
      if (quality) {
        ...
        (_b2 = this._media.logger) == null ? void 0 : _b2.warnGroup("[vidstack] failed quality change request (invalid index)").labelledLog("Qualities", this._media.qualities.toArray()).labelledLog("Index", index).labelledLog("Request Event", event).dispatch();
      }
    }
  }
  ...
  ["media-text-track-change-request"](event) {
    ...
    if (track) {
      ...
      (_a3 = this._media.logger) == null ? void 0 : _a3.warnGroup("[vidstack] failed text track change request (invalid index)").labelledLog("Text Tracks", this._media.textTracks.toArray()).labelledLog("Index", index).labelledLog("Request Event", event).dispatch();
    }
  }
  ...
  _logError(title, error, request) {
    var _a3;
    (_a3 = this._media.logger) == null ? void 0 : _a3.errorGroup(`[vidstack] ${title}`).labelledLog("Error", error).labelledLog("Media Context", { ...this._media }).labelledLog("Trigger Event", request).dispatch();
  }
};
...
var MediaStateManager = class extends MediaPlayerController {
  ...
  _pausePlaybackOnDisconnect() {
    ...
    (_a3 = this._media.$provider()) == null ? void 0 : _a3.pause();
  }
  _resetTracking() {
    this._stopWaiting();
    this._clipEnded = false;
  ...
  ["provider-loader-change"](event) {
    var _a3, _b2;
    {
      (_b2 = this._media.logger) == null ? void 0 : _b2.infoGroup(`Loader change \`${(_a3 = event.detail) == null ? void 0 : _a3.constructor.name}\``).labelledLog("Event", event).dispatch();
    }
  }
  ["auto-play"](event) {
  ...
  ["remote-playback-change"](event) {
    ...
    if (isConnected) {
      this._satisfyRequest(key2, event);
    } else {
      const requestEvent = this._request._queue._peek(key2);
      if (requestEvent) {
        event.request = requestEvent;
        event.triggers.add(requestEvent);
      }
  ...
  ["time-update"](event) {
    ...
    const { realCurrentTime, played, waiting, clipEndTime, loop } = this.$state, endTime = clipEndTime(), detail = event.detail;
...
var _NavigatorMediaSession = class _NavigatorMediaSession2 extends MediaPlayerController {
  constructor() {
    super();
  }
  onConnect() {
    ...
    for (const action of _NavigatorMediaSession2._actions) {
...
var LogPrinter = class extends ViewController {
  ...
  onConnect() {
    this.listen("vds-log", (event) => {
      var _a3, _b2;
      event.stopPropagation();
      const element = ((_a3 = event.path) == null ? void 0 : _a3[0]) ?? (event.target instanceof ViewController ? event.target.el : event.target), eventTargetName = ((_b2 = element == null ? void 0 : element.$$COMPONENT_NAME) == null ? void 0 : _b2.replace(/^_/, "").replace(/Instance$/, "")) ?? (element == null ? void 0 : element.tagName.toLowerCase()) ?? "unknown";
...
var _MediaPlayer = class _MediaPlayer2 extends Component2 {
  constructor() {
    super();
  ...
  _watchTitle() {
    ...
    if (!IS_SERVER2 && (el == null ? void 0 : el.hasAttribute("title"))) {
  ...
  _queuePlaybackRateUpdate(rate) {
    this.canPlayQueue._enqueue("rate", () => {
      var _a3, _b2;
      if (this._provider)
        (_b2 = (_a3 = this._provider).setPlaybackRate) == null ? void 0 : _b2.call(_a3, rate);
    });
  }
  _watchPlaysInline() {
  ...
  _queuePlaysInlineUpdate(inline) {
    this.canPlayQueue._enqueue("playsinline", () => {
      var _a3, _b2;
      if (this._provider)
        (_b2 = (_a3 = this._provider).setPlaysInline) == null ? void 0 : _b2.call(_a3, inline);
    });
  }
  _watchStorage() {
    var _a3;
    ...
    if (storage == null ? void 0 : storage.onChange) {
      const { source } = this.$state, playerId = isString(storageValue) ? storageValue : (_a3 = this.el) == null ? void 0 : _a3.id, mediaId = computed(this._computeMediaId.bind(this));
...
var SourceSelection = class {
  ...
  _onSourceChange() {
    ...
    const sources = $state.sources(), currentSource = peek($state.source), newSource = this._findNewSource(currentSource, sources), noMatch = ((_a3 = sources[0]) == null ? void 0 : _a3.src) && !newSource.src && !newSource.type;
...
Falling back to fetching source headers...`
  ...
  _findNewSource(currentSource, sources) {
    let newSource = { src: "", type: "" }, newLoader = null, loaders = this._loaders();
  ...
  _notifySourceChange(src, loader) {
    ...
    this._notify("media-type-change", (loader == null ? void 0 : loader.mediaType(src)) || "unknown");
  }
  _notifyLoaderChange(loader) {
    ...
    loader && peek(() => {
      var _a3;
      return (_a3 = loader.preconnect) == null ? void 0 : _a3.call(loader, this._media);
    });
    this._loader.set(loader);
  ...
  _onLoadSource() {
    ...
    if (this._media.$state.canLoad()) {
      ...
      peek(() => {
        ...
        return provider == null ? void 0 : provider.loadSource(source, preload).catch((error) => {
          var _a4;
          {
            (_a4 = this._media.logger) == null ? void 0 : _a4.errorGroup("[vidstack] failed to load source").labelledLog("Error", error).labelledLog("Source", source).labelledLog("Provider", provider).labelledLog("Media Context", { ...this._media }).dispatch();
          }
        });
      });
      return () => abort.abort();
    ...
    try {
      ...
      {
        (_a3 = this._media.logger) == null ? void 0 : _a3.infoGroup(`Failed to preconnect to source: ${source.src}`).labelledLog("Error", error).dispatch();
      }
    }
  }
  _onLoadPoster() {
    const loader = this._loader(), { source, canLoadPoster } = this._media.$state;
    if (!loader || !loader.loadPoster || !source() || !canLoadPoster())
      return;
...
function normalizeSrc(src) {
  return (isArray(src) ? src : [!isString(src) && "src" in src ? src : { src }]).map(({ src: src2, type, ...props }) => ({
    src: src2,
    type: type ?? (isString(src2) ? sourceTypes.get(src2) : null) ?? (!isString(src2) || src2.startsWith("blob:") ? "video/object" : src2.includes("youtube") ? "video/youtube" : src2.includes("vimeo") && !src2.includes("progressive_redirect") ? "video/vimeo" : "?"),
    ...props
  })).sort((a) => a.type === "?" ? 1 : -1);
}
...
var MediaProvider = class extends Component2 {
  constructor() {
    super(...arguments);
...
var Controls = class extends Component2 {
  onSetup() {
    this._media = useMediaContext();
...
var Popper = class extends ViewController {
  ...
  onDestroy() {
    var _a3;
    (_a3 = this._stopAnimationEndListener) == null ? void 0 : _a3.call(this);
    this._stopAnimationEndListener = null;
  }
  _watchTrigger() {
...
var id = 0;
var Tooltip = class extends Component2 {
  constructor() {
    super();
...
var TooltipTrigger = class extends Component2 {
  constructor() {
    super();
    new FocusVisibleController();
  }
  ...
  _attach() {
    const button = this._getButton(), tooltip = useContext2(tooltipContext);
...
var TooltipContent = class extends Component2 {
  constructor() {
    super();
    new FocusVisibleController();
...
var ToggleButton = class extends Component2 {
  constructor() {
    super();
...
var AirPlayButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
...
var GoogleCastButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var PlayButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var CaptionButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var FullscreenButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var MuteButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var PIPButton = class extends Component2 {
  constructor() {
    super();
    new ToggleButtonController({
      _isPressed: this._isPressed.bind(this),
...
var SeekButton = class extends Component2 {
  constructor() {
    super();
    new FocusVisibleController();
  }
...
var LiveButton = class extends Component2 {
  constructor() {
    super();
    new FocusVisibleController();
  }
...
var SliderEventsController = class extends ViewController {
  ...
  _watchSwipeGesture() {
    ...
    this._provider = (_a3 = this._media.player.el) == null ? void 0 : _a3.querySelector(
  ...
  _updateValue(newValue, trigger) {
    ...
    this.dispatch(event);
    (_b2 = (_a3 = this._delegate)._onValueChange) == null ? void 0 : _b2.call(_a3, event);
    if (dragging()) {
  ...
  _onStartDragging(value, trigger) {
    ...
    this.dispatch(event);
    (_b2 = (_a3 = this._delegate)._onDragStart) == null ? void 0 : _b2.call(_a3, event);
  }
  _onStopDragging(value, trigger) {
    ...
    this.dispatch(event);
    (_b2 = (_a3 = this._delegate)._onDragEnd) == null ? void 0 : _b2.call(_a3, event);
    this._touch = null;
    this._touchStartValue = null;
  }
  _onKeyDown(event) {
...
var Slider = class extends Component2 {
  constructor() {
    super();
...
var ThumbnailsLoader = class _ThumbnailsLoader {
      ...
      if (!pending.has(currentKey)) {
        const promise = new Promise(async (resolve, reject) => {
          try {
            ...
            import("./dev-5KEHKMO3.js").then(async ({ parseResponse }) => {
              try {
  ...
  _processStoryboard(board) {
    ...
    assert(isArray(board.tiles) && ((_a3 = board.tiles) == null ? void 0 : _a3.length), `Empty tiles in storyboard`);
  ...
  _onError(src, error) {
    ...
    if (warned == null ? void 0 : warned.has(src))
      return;
    (_a3 = this._media.logger) == null ? void 0 : _a3.errorGroup("[vidstack] failed to load thumbnails").labelledLog("Src", src).labelledLog("Error", error).dispatch();
    warned == null ? void 0 : warned.add(src);
  }
};
var Thumbnail = class extends Component2 {
  constructor() {
    super(...arguments);
    this._styleResets = [];
  }
...
var SliderVideo = class extends Component2 {
  get video() {
...
var SliderValue = class extends Component2 {
  onSetup() {
    this._slider = useState2(Slider.state);
  ...
  getValueText() {
    ...
    if (_format === "percent") {
      ...
      return ((_b2 = (_a3 = this._format).value) == null ? void 0 : _b2.call(_a3, value)) ?? value.toFixed(2);
    }
  }
};
SliderValue.props = {
...
var SliderPreview = class extends Component2 {
  constructor() {
    super(...arguments);
...
var VolumeSlider = class extends Component2 {
  constructor() {
    super(...arguments);
...
var TimeSlider = class extends Component2 {
  constructor() {
    super();
  ...
  _hasChapters() {
    ...
    return ((_a3 = this._chapter()) == null ? void 0 : _a3.cues.length) && Number.isFinite(duration()) && duration() > 0;
  }
...
var SliderChapters = class extends Component2 {
  constructor() {
    super(...arguments);
    this._titleRef = null;
    this._refs = [];
    ...
    this._updateBufferedPercent = animationFrameThrottle((bufferedPercent) => {
      ...
      for (let i = this._bufferedIndex; i < this._refs.length; i++) {
        ...
        (_a3 = this._refs[i]) == null ? void 0 : _a3.style.setProperty("--chapter-progress", percent + "%");
        if (percent < 100) {
  ...
  setRefs(refs) {
    var _a3;
    this._refs = refs;
    (_a3 = this._updateScope) == null ? void 0 : _a3.dispose();
  ...
  _watchFillPercent() {
    let { liveEdge, ended, clipStartTime, clipEndTime } = this._media.$state, { fillPercent, value } = this._sliderState, cues = this._$cues(), isLiveEdge = liveEdge(), prevActiveIndex = peek(this._activeIndex), currentChapter = cues[prevActiveIndex];
  ...
  _findActiveChapterIndex(startIndex, percent) {
    let chapterPercent = 0, cues = this._$cues(), { clipStartTime } = this._media.$state, startTime = clipStartTime(), endTime = this._getEndTime(cues);
  ...
  _fillGaps(cues) {
    ...
    if (lastCue) {
      ...
      if (duration() >= 0 && (endTime === 0 || endTime !== Infinity && lastCue.endTime < endTime) && Math.abs(lastCue.endTime - duration()) > 1) {
...
var MenuFocusController = class {
  ...
  _focusAt(index) {
    var _a3;
    this._index = index;
    (_a3 = this._elements[index]) == null ? void 0 : _a3.focus();
    this._scroll(index);
  }
  _findActiveIndex() {
  ...
  _nextIndex(delta) {
    ...
    } while (((_a3 = this._elements[index]) == null ? void 0 : _a3.offsetParent) === null);
    return index;
  }
...
var idCount = 0;
var Menu = class extends Component2 {
  constructor() {
    super();
  ...
  onConnect(el) {
    ...
    if (this.isSubmenu) {
      (_a3 = this._parentMenu) == null ? void 0 : _a3._addSubmenu(this);
    }
  }
  onDestroy() {
    this._trigger.set(null);
  ...
  _onExpandedChange(isExpanded, event) {
    ...
    if (isExpanded) {
      if (!this.isSubmenu && this._media.activeMenu !== this) {
        (_b2 = this._media.activeMenu) == null ? void 0 : _b2.close(event);
        this._media.activeMenu = this;
      }
      (_d = (_c2 = this._menuObserver) == null ? void 0 : _c2._onOpen) == null ? void 0 : _d.call(_c2, event);
    } else {
      if (this.isSubmenu) {
        setTimeout(() => {
  ...
  _onWindowPointerUp(event) {
    ...
    if (!isTargetNode || ((_a3 = this._content()) == null ? void 0 : _a3.contains(event.target)))
      return;
    if (this.isSubmenu)
...
var MenuButton = class extends Component2 {
  constructor() {
    super();
  ...
  get expanded() {
    var _a3;
    return ((_a3 = this._menu) == null ? void 0 : _a3._expanded()) ?? false;
  }
  onSetup() {
...
var MenuPortal = class extends Component2 {
  constructor() {
    super(...arguments);
    this._target = null;
  }
  ...
  onDestroy() {
    var _a3;
    (_a3 = this._target) == null ? void 0 : _a3.remove();
    this._target = null;
  }
  _attachElement(el) {
    this._portal(false);
  ...
  _portal(shouldPortal) {
    ...
    if (shouldPortal) {
      ...
      this._target.remove();
      (_a3 = this.el) == null ? void 0 : _a3.append(this._target);
    }
  }
...
var MenuItems = class extends Component2 {
  constructor() {
    super();
    new FocusVisibleController();
    const { placement } = this.$props;
...
var RadioGroupController = class extends ViewController {
  ...
  _onChange(newValue, trigger) {
    ...
    (_a3 = this._onValueChange) == null ? void 0 : _a3.call(this, newValue, trigger);
  }
  _findRadio(newValue) {
...
var RadioGroup = class extends Component2 {
  get values() {
...
var Radio = class extends Component2 {
  constructor() {
    super();
  ...
  _watchValue() {
    ...
    if (peek(this._checked)) {
      (_b2 = (_a3 = this._controller)._onCheck) == null ? void 0 : _b2.call(_a3, newValue);
    }
  }
  _onPress(event) {
    var _a3, _b2;
    ...
    (_b2 = (_a3 = this._controller)._onCheck) == null ? void 0 : _b2.call(_a3, peek(this.$props.value), event);
  }
...
var ChaptersRadioGroup = class extends Component2 {
  constructor() {
    super();
  ...
  get disabled() {
    var _a3;
    return !((_a3 = this._cues()) == null ? void 0 : _a3.length);
  }
  onSetup() {
    this._media = useMediaContext();
    if (hasProvidedContext(menuContext)) {
  ...
  onAttach(el) {
    var _a3;
    (_a3 = this._menu) == null ? void 0 : _a3._attachObserver({
  ...
  _watchCurrentTime() {
    var _a3;
    if (!((_a3 = this._menu) == null ? void 0 : _a3._expanded()))
      return;
    const track = this._track();
    if (!track) {
      this._index.set(-1);
  ...
  _watchControllerDisabled() {
    var _a3;
    (_a3 = this._menu) == null ? void 0 : _a3._disable(this.disabled);
  }
  _getValue() {
...
var AudioRadioGroup = class extends Component2 {
  get value() {
    return this._controller.value;
  }
  get disabled() {
  ...
  _watchHintText() {
    ...
    (_a3 = this._menu) == null ? void 0 : _a3._hint.set((track == null ? void 0 : track.label) ?? emptyLabel());
  }
  _watchControllerDisabled() {
    var _a3;
    (_a3 = this._menu) == null ? void 0 : _a3._disable(this.disabled);
...
var CaptionsRadioGroup = class extends Component2 {
  get value() {
    return this._controller.value;
  }
  get disabled() {
  ...
  _watchHintText() {
    ...
    (_a3 = this._menu) == null ? void 0 : _a3._hint.set(
...
var SpeedRadioGroup = class extends Component2 {
  get value() {
    return this._controller.value;
  }
  get disabled() {
  ...
  _watchHintText() {
    ...
    (_a3 = this._menu) == null ? void 0 : _a3._hint.set(rate === 1 ? normalLabel() : rate + "×");
  }
  _watchControllerDisabled() {
    var _a3;
    (_a3 = this._menu) == null ? void 0 : _a3._disable(this.disabled);
...
var QualityRadioGroup = class extends Component2 {
  constructor() {
    super();
...
var Gesture = class extends Component2 {
  constructor() {
    super(...arguments);
    this._provider = null;
    this._presses = 0;
...
var Captions = class extends Component2 {
  onSetup() {
    this._media = useMediaContext();
    this.setAttributes({
      "aria-hidden": $ariaBool(this._isHidden.bind(this))
  ...
  onConnect(el) {
    ...
    import("./dev-5KEHKMO3.js").then((lib) => {
      if (!this.connectScope)
        return;
      scoped(() => {
        this._lib = lib;
  ...
  onDestroy() {
    ...
    (_a3 = this._renderer) == null ? void 0 : _a3.destroy();
  }
  _isHidden() {
    const { textTrack, remotePlaybackState } = this._media.$state, track = textTrack();
    return this._media.$iosControls() || remotePlaybackState() === "connected" || !track || !isTrackCaptionKind(track);
  }
  _watchViewType() {
  ...
  _onCueChange() {
    this.el.textContent = "";
    const { realCurrentTime, textTrack } = this._media.$state, time = peek(realCurrentTime), activeCues = peek(textTrack).activeCues;
...
var Poster = class extends Component2 {
  constructor() {
    super(...arguments);
    this._prevSrc = "";
  }
...
var Time = class extends Component2 {
  constructor() {
    super(...arguments);
  ...
  _watchTime() {
    const { type, padHours, padMinutes, showHours } = this.$props, seconds = this._getSeconds(type()), duration = this._media.$state.duration(), shouldInvert = this._shouldInvert();
    if (!Number.isFinite(seconds + duration)) {
      this.$state.timeText.set("LIVE");
      return;
    }
    const time = shouldInvert ? Math.max(0, duration - seconds) : seconds, formattedTime = formatTime(time, padHours(), padMinutes(), showHours());
...
var plyrLayoutContext = createContext2();
var plyrLayoutProps = {
  clickToPlay: true,
...
var PlyrLayout = class extends Component2 {
  onSetup() {
    this._media = useMediaContext();
...
function isRemotionProvider(provider) {
  return (provider == null ? void 0 : provider.$$PROVIDER_TYPE) === "REMOTION";
}
...
function useMediaState(prop2, ref) {
  ...
  return useSignal((((_a3 = ref == null ? void 0 : ref.current) == null ? void 0 : _a3.$state) || $state || initialMediaStore)[prop2]);
}
...
//# sourceMappingURL=chunk-NQW6PDO3.js.map
