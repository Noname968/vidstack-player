...
// node_modules/@vidstack/react/dist/dev/chunks/vidstack-BMiDnKnR.js
...
var YouTubeProvider = class extends EmbedProvider {
  ...
  _onStateChange(state, trigger) {
    ...
    if (!started() && isPlay && this._pausedSeeking) {
      (_a = this._playPromise) == null ? void 0 : _a.reject("invalid internal play operation");
      this._playPromise = null;
      if (isPlaying) {
        this.pause();
        this._pausedSeeking = false;
    ...
    if (isPlay) {
      (_b = this._playPromise) == null ? void 0 : _b.resolve();
      this._playPromise = null;
...
//# sourceMappingURL=vidstack-BMiDnKnR-WNFJS34J.js.map
