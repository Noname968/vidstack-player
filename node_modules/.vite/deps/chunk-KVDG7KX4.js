...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-P5SLNECJ.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-NIFC5QOQ.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-JVTE3XML.js")).ParseErrorBuilder;
  }
...
//# sourceMappingURL=chunk-KVDG7KX4.js.map
